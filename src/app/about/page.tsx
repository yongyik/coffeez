  ...
  return (
    <>
      <AboutSection
        ...
        image={{ src: "/images/about/coffee-beans-in-hand.jpg", alt: "手握新鲜烘焙咖啡豆的特写" }}
      />
      ...
      <AboutSection
        ...
        image={{ src: "/images/about/barista-pouring-coffee.jpg", alt: "咖啡师专注地制作一杯咖啡" }}
      />
      ...
      <AboutSection
        ...
        image={{ src: "/images/about/green-coffee-shop-interior.jpg", alt: "绿植环绕的咖啡店空间" }}
      />
      ...
      <AboutSection
        ...
        image={{ src: "/images/about/coffee-shop-team.jpg", alt: "我们的咖啡店团队合照" }}
      />
